...
Click any task to open a modal window where:

You can view task details (title and description).

See or change the current status from the dropdown.

Click the Close (×) button in the modal to exit and return to the board.
